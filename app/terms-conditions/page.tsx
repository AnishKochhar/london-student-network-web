        ...
        <div className="min-h-screen bg-gray-900 text-gray-300 px-10 py-20">
            <div className="max-w-4xl mx-auto">
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        Welcome to London Students Network LLC (“Company”, “we”,
                        “our”, “us”)! As you have just clicked our Terms of
                        Service, please pause, grab a cup of coffee and
                    ...
                    <p className="mt-4">
                        ...
                        <a
                            href="https://www.londonstudentnetwork.com"
                    ...
                    <p className="mt-4">
                        ...
                        so we can try to find a solution. These Terms apply to
                        all visitors, users and others who wish to access or use
                        Service.
                    </p>
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        including, without limitation, your credit card number,
                        the expiration date of your credit card, your billing
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        Promotions, please review the applicable rules. If the
                        rules for a Promotion conflict with these Terms of
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        unless you cancel it or London Students Network LLC
                        cancels it. You may cancel your Subscription renewal
                        either through your online account management page or by
                        contacting London Students Network LLC customer support
                        team.
                    </p>
                    <p className="mt-4">
                        A valid payment method, including credit card or PayPal,
                        is required to process the payment for your
                        subscription. You shall provide London Students Network
                        LLC with accurate and complete billing information
                        ...
                        authorize London Students Network LLC to charge all
                        Subscription fees incurred through your account to any
                        such payment instruments.
                    </p>
                    <p className="mt-4">
                        Should automatic billing fail to occur for any reason,
                        London Students Network LLC will issue an electronic
                        invoice indicating that you must proceed manually,
                        within a certain deadline date, with the full payment
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        London Students Network LLC, in its sole discretion and
                        at any time, may modify Subscription fees for the
                        Subscriptions. Any Subscription fee change will become
                        effective at the end of the then-current Billing Cycle.
                    </p>
                    <p className="mt-4">
                        London Students Network LLC will provide you with a
                        reasonable prior notice of any change in Subscription
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        We issue refunds for Contracts within fifteen (15) days
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        property of London Students Network LLC or used with
                ...
                <section className="mt-8">
                    ...
                    <ul className="list-disc ml-8 mt-4">
                        ...
                        <li>
                            ...
                            which, as determined by us, may harm or offend
                            Company or users of Service or expose them to
                            liability.
                        </li>
                    </ul>
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        age and with the full authority, right, and capacity to
                        enter into this agreement and abide by all of the terms
                        and conditions of Terms. If you are not at least
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        of your account and password, including but not limited
                        to the restriction of access to your computer and/or
                        account. You agree to accept responsibility for any and
                        all activities or actions that occur under your account
                        and/or password, whether your password is with our
                        Service or a third-party service. You must notify us
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        will remain the exclusive property of London Students
                        Network LLC and its licensors. Service is protected by
                        ...
                        the prior written consent of London Students Network
                        LLC.
                    </p>
                </section>
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        matters related to our Service (“Feedback”). You
                        acknowledge and agree that: (i) you shall not retain,
                        acquire or assert any intellectual property right or
                        ...
                        information or proprietary information from you or any
                        third party; and (iv) Company is not under any
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        or services that are not owned or controlled by London
                        Students Network LLC.
                    </p>
                    <p className="mt-4">
                        London Students Network LLC has no control over, and
                        assumes no responsibility for the content, privacy
                        policies, or practices of any third party web sites or
                        services. We do not warrant the offerings of any of
                        these entities/individuals or their websites.
                    </p>
                    <p className="mt-4">
                        YOU ACKNOWLEDGE AND AGREE THAT LONDON STUDENTS NETWORK
                        LLC SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        “AS AVAILABLE” BASIS. COMPANY MAKES NO REPRESENTATIONS
                    ...
                    <p className="mt-4">
                        ...
                        COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY,
                        OR AVAILABILITY OF THE SERVICES. WITHOUT LIMITING THE
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        OF LITIGATION AND ARBITRATION, OR AT TRIAL OR ON APPEAL,
                        IF ANY, WHETHER OR NOT LITIGATION OR ARBITRATION IS
                        INSTITUTED), WHETHER IN AN ACTION OF CONTRACT,
                        NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING OUT OF
                        ...
                        EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND
                        ON THE PART OF COMPANY, IT WILL BE LIMITED TO THE AMOUNT
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        accordance with the laws of United Kingdom without
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        We reserve the right to withdraw or amend our Service,
                        and any service or material we provide via Service, in
                        our sole discretion without notice. We will not be
                        liable if for any reason all or any part of Service is
                        unavailable at any time or for any period. From time to
                        time, we may restrict access to some parts of Service,
                        or the entire Service, to users, including registered
                        users.
                    </p>
                </section>
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-4">
                        ...
                        in Terms shall be deemed a further or continuing waiver
                        of such term or condition or a waiver of any other term
                        or condition, and any failure of Company to assert a
                        right or provision under Terms shall not constitute a
                    ...
                    <p className="mt-4">
                        ...
                        such that the remaining provisions of Terms will
