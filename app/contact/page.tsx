					...
					<div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
						<div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/20">
							...
							<div className="space-y-2">
								<Link href="mailto:hello@londonstudentnetwork.com" className="hover:underline font-bold">hello@londonstudentnetwork.com</Link>
							</div>
						</div>
					...
					<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div>
								<label className="block text-sm font-medium text-white mb-2">
									Inquiry Purpose <span className="text-red-400">*</span>
								</label>
								<div className="relative">
									<select
										{...register("inquiryPurpose", { required: "Please select an inquiry purpose" })}
									...
									>
										<option value="" className="text-gray-800">Choose one option...</option>
								...
								{errors.inquiryPurpose && (
									<p className="text-red-400 text-sm mt-1">{errors.inquiryPurpose.message}</p>
								)}
							</div>
							...
							<div>
								<label className="block text-sm font-medium text-white mb-2">
									Description that fits you <span className="text-red-400">*</span>
								</label>
								<div className="relative">
									<select
										{...register("description", { required: "Please select a description" })}
										className="w-full px-4 py-3 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl text-white appearance-none focus:ring-2 focus:ring-blue-400 focus:border-transparent placeholder-gray-300"
									>
										<option value="" className="text-gray-800">Choose one option...</option>
						...
						{status && (
							<div className="text-center">
								<p className={`text-sm font-medium ${status.includes('success') ? 'text-green-400' :
