...
const ReplyList = ({
    ...
    const allReplies =
        viewContext?.type === "comment" ? commentReplies : threadReplies;
    const listTitle =
    ...
    }, [viewContext?.type, commentReplies, threadReplies, allReplies]);
        ...
        try {
            const contextId =
                viewContext.type === "comment"
                    ? viewContext.comment.id
                    : viewContext.threadId;
