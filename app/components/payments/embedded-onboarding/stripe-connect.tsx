...
export default function EmbeddedStripeConnectOnboardingForm() {
    ...
    useEffect(() => {
        const initializeStripeConnect = async () => {
            try {
                const instance = await getPublicStripeConnectPromise();
        ...
        <div className="w-full mx-auto p-6 bg-transparent rounded-lg text-white">
            ...
            <div className="text-center mb-6">
                <p className="text-sm text-white">
                    ...
                    <br />
                    <span className="text-white opacity-70">You can always complete this process later from your account settings.</span>
                </p>
            </div>
