            ...
            <div className="flex flex-col items-center w-full max-w-[1000px] mb-10">
                ...
                {debouncedQuery && (
                    <p className="text-blue-300 text-sm mt-2 text-left w-full md:w-2/3 lg:w-1/2">
                        {filteredSponsors.length} result
                ...
                {filteredSponsors.map((sponsor) => (
                    ...
                    >
                        ...
                        {sponsor.website && (
                            ...
                            >
                                <span className="relative z-10 transition-all duration-300 ease-in-out group-hover/button:-translate-x-4">
                                    Visit Website
                                </span>
