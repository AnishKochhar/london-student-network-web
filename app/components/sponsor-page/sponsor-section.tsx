    ...
    return (
        <section className="relative w-full min-h-screen flex flex-col justify-center bg-center bg-cover bg-no-repeat pt-60 md:py-32">
            ...
            <div className="relative z-10 text-centre text-white max-w-full mx-auto ">
                ...
                <div
                    className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-${rows} gap-6 mt-10`}
                >
                    {sortedSponsors.map((company, index) => (
                        ...
                        >
                            ...
                            {company.website && (
                                <div className="relative flex w-full items-center text-left flex-row-reverse">
