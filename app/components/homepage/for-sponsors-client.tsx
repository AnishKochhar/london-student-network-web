...
export default function ForSponsorsClient() {
    ...
    return (
        <section
            ref={sectionRef}
            className="flex flex-col items-start justify-center min-h-screen p-10 snap-start"
        >
            <motion.h2
                style={{ x }}
            ...
            <TextRevealSection
                texts={[
                    "We help organise events that reach the entire university student community across London.",
