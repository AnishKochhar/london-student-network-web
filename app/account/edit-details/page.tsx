...
export default function EditDetailsPage() {
    ...
    const onSubmit = async (data: OrganiserAccountEditFormData) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                toast.error(`Error editing account: ${result.error}`, {
                    id: toastId,
                });
                console.error("Error editing account:", result.error);
            }
        } catch (error) {
            toast.error(`Error during account updating: ${error.message}`, {
                id: toastId,
            });
    ...
    return (
        <div className="min-h-screen flex flex-col justify-start p-10 bg-gradient-to-b from-[#041A2E] via-[#064580] to-[#083157]">
                    ...
                    render={({ field }) => (
                        <Select
                            ...
                            value={field.value.map((tag) =>
                                predefinedTags.find((t) => t.value === tag),
                            )}
            ...
            <div>
                ...
                <div className="flex justify-end mt-6 items-center">
                    <Button
                        ...
                        className="p-3 text-white rounded-lg hover:bg-slate-500"
                    >
                        Save changes
                    </Button>
                </div>
            ...
            <div className="my-5">
                If you would like to change any of the greyed-out fields, please
                get in touch at hello@londonstudentnetwork.com, and one of the
