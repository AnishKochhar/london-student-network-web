...
export default function VerifyCombinedEmail() {
    ...
    useEffect(() => {
        ...
        const verifyEmail = async () => {
            ...
            try {
                const response = await fetch("/api/email/verify-combined-email", {
                    method: "POST",
                ...
                if (result.success) {
                    setStatus("success");
                    setMessage("Your email and university account have been verified successfully!");
                } else {
                    setStatus("error");
        ...
        verifyEmail();
    }, [searchParams, hasAttemptedVerification]);
                ...
                {status === "success" && (
                    <>
                        ...
                        <p className="text-gray-400 text-sm mb-6">
                            You can now access university-exclusive events and all platform features.
                        </p>
                        <Link
                            href="/account"
